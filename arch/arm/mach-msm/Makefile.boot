...
# Qisda, Daniel Lee, 2014/02/27, Choose DTS by PCB version {
	dtb-$(CONFIG_ARCH_MSM8226)	+= t3-msm8926-720p-mtp-evt1.dtb
	dtb-$(CONFIG_ARCH_MSM8226)	+= t3-msm8926-720p-mtp-evt1_2.dtb
	dtb-$(CONFIG_ARCH_MSM8226)	+= t3-msm8926-720p-mtp-evt2.dtb
	dtb-$(CONFIG_ARCH_MSM8226)	+= t3-msm8926-720p-mtp-evt2_2.dtb
# Qisda, Daniel Lee, 2014/02/27, Choose DTS by PCB version }
