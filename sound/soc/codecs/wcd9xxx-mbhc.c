...
#define WCD9XXX_CS_MEAS_INVALD_RANGE_LOW_MV 190
#define WCD9XXX_CS_MEAS_INVALD_RANGE_HIGH_MV 230
...
static int wcd9xxx_is_false_press(struct wcd9xxx_mbhc *mbhc)
{
	...
	while (time_before(jiffies, timeout)) {
		...
		if (i == 0) {
            ...
            if(6200 < mb_v && mb_v < 6700)
                mb_v -= 300;
            else if(13000 < mb_v && mb_v < 14000)
                mb_v -= 1000;
            else if(7500 < mb_v && mb_v < 8000)
                mb_v -= 1500;
            
            
            if (mb_v < v_b1_hu || mb_v > v_ins_hu) {
                printk("[Bill] mb_v=%d, v_v1_hu=%d, v_ins_hu=%d \n", mb_v, v_b1_hu, v_ins_hu);
            ...
            if(950 < mb_v && mb_v < 1100)
                mb_v -= 100;
            else if(1100 < mb_v && mb_v < 1300)
                mb_v -= 300;
