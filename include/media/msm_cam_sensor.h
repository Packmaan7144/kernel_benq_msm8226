...
struct otp_struct_q {
	...
	uint8_t minute;
	uint8_t second;
	uint16_t rg_ratio_d50;
	uint16_t bg_ratio_d50;
	uint16_t gb_gr_d50;
	uint8_t af_start_dac_msb;
	uint8_t af_start_dac_lsb;
	uint8_t af_macro_dac_msb;
	uint8_t af_macro_dac_lsb;
	uint16_t light_rg_ratio_d50;
	uint16_t light_bg_ratio_d50;
