...
struct mdss_dsi_ctrl_pdata {
	...
	struct dentry *lcm_dbgfsdir;
	
	int current_cmd_set;
	int various_on_cmds;
	struct dsi_panel_cmds on_cmds_head;
	struct dsi_panel_cmds on_cmds_tail;
	int on_cmds_number;
	struct dsi_panel_cmds* on_cmds_bluelight_mode;
	struct dsi_panel_cmds cmds_custom_in;
	struct dsi_panel_cmds cmds_custom_out;
	int (*set_blue_light_mode) (void *data, u64 value);
